...
<!ENTITY % ish-reusableobject-atts
...
<!ENTITY % esri_layout-atts
                         'esri_layout ( left-sidebar | main-body | full-body ) "main-body" '                  >
...
<!-- tchen: !ENTITY % tblcell.cnt          "#PCDATA | %basic.ph; | %basic.block.notbl;  | %txt.incl; | %data.elements.incl; | %foreign.unknown.incl;" -->
<!ENTITY % tblcell.cnt          "%basic.ph; | %basic.block.notbl;  | %txt.incl; | %data.elements.incl; | %foreign.unknown.incl;">
...
<!-- tchen: !ENTITY % words.cnt            "#PCDATA | %keyword; | %term; | %data.elements.incl; | %foreign.unknown.incl;" -->
<!ENTITY % words.cnt            "#PCDATA | %ph; |  %tm; | %keyword; | %term; | %data.elements.incl; | %foreign.unknown.incl;">

<!-- tchen: !ENTITY % data.cnt             "%words.cnt;|%image;|%object;|%ph;|%title;" -->
<!ENTITY % data.cnt             "%words.cnt;|%image;|%object; |%title;">
...
<!ENTITY % esri_licenserestriction-att 
    ' esri_restriction (none | _advanced_only | _advanced_and_standard_only | _limited_in_basic | arcinfo_only | arcinfo_and_arceditor_only | limited_in_arcview |  -dita-use-conref-target) "none"'>
<!-- ============================================================= -->
...
<!ATTLIST image           
             ...
             placement  CDATA		 #FIXED				 "inline"
             ishtype    CDATA        #FIXED              "ISHIllustration"
             ishpreviewversion       CDATA               #IMPLIED
             %ish-variables-atts;
             %univ-atts;
             ishlabelxpath CDATA #FIXED "./title | @alt | @href | @conref | self::*[@id and not(@varid)]/@id"
             ishlinkxpath CDATA #FIXED "@conref | @href[contains(parent::*/@class,&apos; topic/image &apos;) and not(parent::*/@conref)]"
...
<!ATTLIST xref            
             ...
             ishlinkxpath CDATA #FIXED "@conref | @href[contains(parent::*/@class,&apos; topic/image &apos;) and not(parent::*/@conref)]"
             format     CDATA                            #IMPLIED
             scope      (book | local | peer | external | 
                         -dita-use-conref-target)        #IMPLIED
             outputclass 
                        CDATA                            #IMPLIED
						 ishhyperlinkxpath CDATA #FIXED "@href[not(ancestor::*[@scope and @scope!=&apos;&apos;][position()=1]/@scope=&apos;external&apos;)]" >


<!ELEMENT esri_license     (#PCDATA | %p;)*                               >
<!ATTLIST esri_license
...
<!ATTLIST esri_license      %global-atts;  class CDATA "- esri_common/esri_license "       >
