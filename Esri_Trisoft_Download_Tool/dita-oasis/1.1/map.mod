...
<!--                    LONG NAME: Map                             -->
<!ELEMENT  map          ((%title;)?, (%topicmeta;)?, (%draft-comment;)?,
...
<!ELEMENT  topicref     ((%topicmeta;)?, (%draft-comment;)?,
...
<!ATTLIST  topicref
            ...
            esri_classification (none | overview | quicktour | vocab ) "none"
            esri_helpid  CDATA                            #IMPLIED
            esri_type (none | 
                             _broadsheetpage |
                             _navigationpage |
                             _storypage  |                              
                             datafile_env |  
                             datafile_banner | 
                             datafile_externalfiles |
                             datafile_gplicense | 
                             datafile_gplicense_notoc |
                             datafile_helpsysdata |
                             datafile_otherhlpsysrefs) "none"
...
<!ATTLIST  relheader
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED   "string('Relationship Column Specification')"
             %univ-atts;
             ishlinkxpath CDATA #FIXED "@conref | @href[contains(parent::*/@class,&apos; topic/image &apos;) and not(parent::*/@conref)]"                                             >        
...
<!ATTLIST  relcolspec
             outputclass 
                        CDATA                             #IMPLIED
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED   "concat(string('Column '), @type)"
             %topicref-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"
             %univ-atts;
                                             >
...
<!ATTLIST relrow
             outputclass 
                        CDATA                             #IMPLIED
						 ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED   "string('Relations')"
             %univ-atts;                                             >
...
<!ATTLIST relcell
             outputclass 
                        CDATA                             #IMPLIED
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Relation '),
                      self::*[count(preceding-sibling::*)+1=1]/../../relheader/relcolspec[1]/@type | 
                      self::*[count(preceding-sibling::*)+1=2]/../../relheader/relcolspec[2]/@type | 
                      self::*[count(preceding-sibling::*)+1=3]/../../relheader/relcolspec[3]/@type | 
                      self::*[count(preceding-sibling::*)+1=4]/../../relheader/relcolspec[4]/@type | 
                      self::*[count(preceding-sibling::*)+1=5]/../../relheader/relcolspec[5]/@type | 
                      self::*[count(preceding-sibling::*)+1=6]/../../relheader/relcolspec[6]/@type | 
                      self::*[count(preceding-sibling::*)+1=7]/../../relheader/relcolspec[7]/@type | 
                      self::*[count(preceding-sibling::*)+1=8]/../../relheader/relcolspec[8]/@type |  
                      ../../relheader/relcolspec[9]/@type |
                      self::*[count(preceding-sibling::*)+1=1]/../../relheader/relcolspec[1]/@linking | 
                      self::*[count(preceding-sibling::*)+1=2]/../../relheader/relcolspec[2]/@linking | 
                      self::*[count(preceding-sibling::*)+1=3]/../../relheader/relcolspec[3]/@linking | 
                      self::*[count(preceding-sibling::*)+1=4]/../../relheader/relcolspec[4]/@linking | 
                      self::*[count(preceding-sibling::*)+1=5]/../../relheader/relcolspec[5]/@linking | 
                      self::*[count(preceding-sibling::*)+1=6]/../../relheader/relcolspec[6]/@linking | 
                      self::*[count(preceding-sibling::*)+1=7]/../../relheader/relcolspec[7]/@linking | 
                      self::*[count(preceding-sibling::*)+1=8]/../../relheader/relcolspec[8]/@linking |  
                      ../../relheader/relcolspec[9]/@linking)"
             %topicref-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"
             %univ-atts;                                             >
...
<!ELEMENT  topicmeta    ((%esri_gptoolboxmeta;)?, (%esri_gptoolsetmeta;)?, (%esri_gptoolmeta;)? , (%linktext;)?, (%searchtitle;)?, 
