...
<!ATTLIST draftintro
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Draft Introduction '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
...
<!ATTLIST bookabstract
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Book Abstract '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
...
<!ATTLIST dedication
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Dedication '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
...
<!ATTLIST preface
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Preface '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
...
<!ATTLIST chapter
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Chapter '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
...
<!ATTLIST appendix
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Appendix '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
...
<!ATTLIST notices
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Notices '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
...
<!ATTLIST amendments
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Amendments '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
...
<!ATTLIST colophon
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Colophon '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
...
<!ATTLIST toc
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Table of Contents '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
...
<!ATTLIST figurelist
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Figure List '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
...
<!ATTLIST tablelist
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Table List '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
...
<!ATTLIST abbrevlist
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Abbreviation List '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
...
<!ATTLIST trademarklist
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Trademark List '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
...
<!ATTLIST bibliolist
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Bibliography List '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
...
<!ATTLIST glossarylist
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Glossary List '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
...
<!ATTLIST indexlist
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Index List '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
...
<!ATTLIST booklist
             ishtype       CDATA   #FIXED   "ISHSection"
             ishlabelxpath CDATA   #FIXED
                      "concat(string('Book List '),@navtitle)"
             %chapter-atts;
             ishlinkxpath CDATA #FIXED "@href[not(parent::*/@scope=&apos;external&apos;)]"                                          >
